...
var file_user_proto_rawDesc = string([]byte{
	...
	0x69, 0x6c, 0x22, 0xb5, 0x02, 0x0a, 0x16, 0x47, 0x65, 0x74, 0x55, 0x73, 0x65, 0x72, 0x42, 0x79,
	...
	0x52, 0x08, 0x69, 0x73, 0x41, 0x63, 0x74, 0x69, 0x76, 0x65, 0x22, 0x47, 0x0a, 0x19, 0x55, 0x70,
	...
	0x09, 0x52, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x32, 0xb7, 0x01, 0x0a, 0x0b, 0x55, 0x73,
...
var file_user_proto_depIdxs = []int32{
	4, // 0: user.GetUserByEmailResponse.created_at:type_name -> google.protobuf.Timestamp
	4, // 1: user.GetUserByEmailResponse.updated_at:type_name -> google.protobuf.Timestamp
	0, // 2: user.UserService.GetUserByEmail:input_type -> user.GetUserByEmailRequest
	2, // 3: user.UserService.UpdateUserPassword:input_type -> user.UpdateUserPasswordRequest
	1, // 4: user.UserService.GetUserByEmail:output_type -> user.GetUserByEmailResponse
	3, // 5: user.UserService.UpdateUserPassword:output_type -> user.UpdateUserPasswordResponse
