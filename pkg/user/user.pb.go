...
var file_proto_user_user_proto_rawDesc = string([]byte{
	...
	0x62, 0x2e, 0x6d, 0x61, 0x69, 0x2e, 0x72, 0x75, 0x2f, 0x63, 0x69, 0x63, 0x61, 0x64, 0x61, 0x2d,
	0x63, 0x68, 0x65, 0x73, 0x73, 0x2f, 0x62, 0x61, 0x63, 0x6b, 0x65, 0x6e, 0x64, 0x2f, 0x75, 0x73,
...
var file_proto_user_user_proto_depIdxs = []int32{
	8, // 0: user.GetUserByEmailResponse.created_at:type_name -> google.protobuf.Timestamp
	8, // 1: user.GetUserByEmailResponse.updated_at:type_name -> google.protobuf.Timestamp
	8, // 2: user.GetUserByIdResponse.created_at:type_name -> google.protobuf.Timestamp
	8, // 3: user.GetUserByIdResponse.updated_at:type_name -> google.protobuf.Timestamp
	...
	1, // 8: user.UserService.GetUserByEmail:output_type -> user.GetUserByEmailResponse
	3, // 9: user.UserService.UpdateUserPassword:output_type -> user.UpdateUserPasswordResponse
	5, // 10: user.UserService.GetUserById:output_type -> user.GetUserByIdResponse
	7, // 11: user.UserService.RegisterUser:output_type -> user.RegisterUserResponse
